...
var printClothes = function(data){


  for (items in data){
    if(data[items].category == "tshirt"){
      tshirt.push(data[items].label);

    }
    else if(data[items].category == "jacket"){
      jackets.push(data[items].label);
    }
    else if(data[items].category == "bottoms"){
      bottoms.push(data[items].label);
    }
    else if(data[items].category == "longshirts"){
      longshirts.push(data[items].label);
    }
    else if(data[items].category == "shorts"){
      shorts.push(data[items].label);
    }

    else if(data[items].category == "warmbottom"){
      warmbottom.push(data[items].label);
    }

    else if(data[items].category == "breezy"){
      breezy.push(data[items].label);
    }
    else if(data[items].category == "summery"){
      summery.push(data[items].label);
    }
